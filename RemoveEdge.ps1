...
<#
	.SYNOPSIS
	Uninstalls or reinstalls Microsoft Edge and its related components. Made by @TeamLimiter.
...
if (!$UninstallEdge -and !$InstallEdge -and !$InstallWebView) {
	$version = '1.9.2'
	$host.UI.RawUI.WindowTitle = "EdgeRemover $version | made by @TeamLimiter"	
