...
if ($args[0] -eq "-ClearUpdateBlocks") {
    $download = "https://cdn.jsdelivr.net/gh/TeamLimiter/EdgeRemover@main/ClearUpdateBlocks.ps1"
} else {
    $download = "https://cdn.jsdelivr.net/gh/TeamLimiter/EdgeRemover@latest/RemoveEdge.ps1"
}
